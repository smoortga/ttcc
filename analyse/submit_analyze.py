...
def main():
    ...
    if not args.infiles == "*": 
        ...
        filelist = [f for f in os.listdir(indir) if not "ttH" in f and not "TTZ" in f]# and not "31Mar" in f]

...
histo_dict = {}
histo_dict["jet1"] = {
    "b" : ROOT.TH1D("b1",";DeepCSV CvsL first jet;Events",nbins,array("d",custom_bins)),
    "c" : ROOT.TH1D("c1",";DeepCSV CvsL first jet;Events",nbins,array("d",custom_bins)),
    "l" : ROOT.TH1D("l1",";DeepCSV CvsL first jet;Events",nbins,array("d",custom_bins)),
}
histo_dict["jet2"] = {
    "b" : ROOT.TH1D("b2",";DeepCSV CvsL second jet;Events",nbins,array("d",custom_bins)),
    "c" : ROOT.TH1D("c2",";DeepCSV CvsL second jet;Events",nbins,array("d",custom_bins)),
    "l" : ROOT.TH1D("l2",";DeepCSV CvsL second jet;Events",nbins,array("d",custom_bins)),
}
histo_dict["jet3"] = {
    "b" : ROOT.TH1D("b3",";DeepCSV CvsL third jet;Events",nbins,array("d",custom_bins)),
    "c" : ROOT.TH1D("c3",";DeepCSV CvsL third jet;Events",nbins,array("d",custom_bins)),
    "l" : ROOT.TH1D("l3",";DeepCSV CvsL third jet;Events",nbins,array("d",custom_bins)),
}

datahisto_dict = {
    "jet1" : ROOT.TH1D("data1",";DeepCSV CvsL first jet;Events",nbins,array("d",custom_bins)),
    "jet2" : ROOT.TH1D("data2",";DeepCSV CvsL second jet;Events",nbins,array("d",custom_bins)),
    "jet3" : ROOT.TH1D("data3",";DeepCSV CvsL third jet;Events",nbins,array("d",custom_bins)),
...
if args.readsamples:
    ...
    for file in samples_MC:
        ...
        hist_tmp_b1 = ROOT.TH1D("h_b1_"+f,";CvsL first add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_c1 = ROOT.TH1D("h_c1_"+f,";CvsL first add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_l1 = ROOT.TH1D("h_l1_"+f,";CvsL first add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_b2 = ROOT.TH1D("h_b2_"+f,";CvsL second add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_c2 = ROOT.TH1D("h_c2_"+f,";CvsL second add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_l2 = ROOT.TH1D("h_l2_"+f,";CvsL second add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_b3 = ROOT.TH1D("h_b3_"+f,";CvsL thrid add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_c3 = ROOT.TH1D("h_c3_"+f,";CvsL thrid add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_l3 = ROOT.TH1D("h_l3_"+f,";CvsL thrid add. jet;Events",nbins,array("d",custom_bins))
        t_ = ROOT.TChain("tree")
        t_.Add(full_path)
        weights_to_apply = weight_string
        t_.Draw("DeepCSVcTagCvsL_addJet1>>h_b1_"+f,weights_to_apply+"*(hadronFlavour_addJet1 == 5)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet1>>h_c1_"+f,weights_to_apply+"*(hadronFlavour_addJet1 == 4)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet1>>h_l1_"+f,weights_to_apply+"*(hadronFlavour_addJet1 == 0)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet2>>h_b2_"+f,weights_to_apply+"*(hadronFlavour_addJet2 == 5)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet2>>h_c2_"+f,weights_to_apply+"*(hadronFlavour_addJet2 == 4)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet2>>h_l2_"+f,weights_to_apply+"*(hadronFlavour_addJet2 == 0)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet3>>h_b3_"+f,weights_to_apply+"*(hadronFlavour_addJet3 == 5)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet3>>h_c3_"+f,weights_to_apply+"*(hadronFlavour_addJet3 == 4)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
        t_.Draw("DeepCSVcTagCvsL_addJet3>>h_l3_"+f,weights_to_apply+"*(hadronFlavour_addJet3 == 0)")#*(mc_pu_trueNumInt>10 && mc_pu_trueNumInt<70)")
    ...
    for file in samples_Data:
        ...
        hist_tmp_data1 = ROOT.TH1D("h_data1_"+f,";CvsL first add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_data2 = ROOT.TH1D("h_data2_"+f,";CvsL second add. jet;Events",nbins,array("d",custom_bins))
        hist_tmp_data3 = ROOT.TH1D("h_data3_"+f,";CvsL thridt add. jet;Events",nbins,array("d",custom_bins))
        t_.Draw("DeepCSVcTagCvsL_addJet1>>h_data1_"+f)
        t_.Draw("DeepCSVcTagCvsL_addJet2>>h_data2_"+f)
        t_.Draw("DeepCSVcTagCvsL_addJet3>>h_data3_"+f)
...
mg1 = ROOT.THStack("mg1",";CvsL first add. jet;Events")
summed_MC_hist1 = ROOT.TH1F("h_summed1",";CvsL first add. jet;Events",nbins,array("d",custom_bins))
...
c1.SaveAs(args.outdir+"/CvsL_AddJet1.pdf")
...
mg2 = ROOT.THStack("mg2",";CvsL first add. jet;Events")
summed_MC_hist2 = ROOT.TH1F("h_summed2",";CvsL first add. jet;Events",nbins,array("d",custom_bins))
...
c2.SaveAs(args.outdir+"/CvsL_AddJet2.pdf")
...
mg3 = ROOT.THStack("mg3",";CvsL first add. jet;Events")
summed_MC_hist3 = ROOT.TH1F("h_summed3",";CvsL first add. jet;Events",nbins,array("d",custom_bins))
...
c3.SaveAs(args.outdir+"/CvsL_AddJet3.pdf")

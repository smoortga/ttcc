...
ItertativeFit_graph_l_TightWP = ROOT.TGraphAsymmErrors(1,np.asarray([80.]),np.asarray([hist_DeepCSVcTag_SFl.GetBinContent(2,2)]),np.asarray([50.]),np.asarray([120.]),np.asarray([hist_DeepCSVcTag_SFl.GetBinContent(2,2)-hist_DeepCSVcTag_SFl_Down.GetBinContent(2,2)]),np.asarray([hist_DeepCSVcTag_SFl_Up.GetBinContent(2,2)-hist_DeepCSVcTag_SFl.GetBinContent(2,2)]) )
...
leg_l.AddEntry(ItertativeFit_graph_l_TightWP,"c-tag shape reweighting","pe")
leg_l.AddEntry(TightWP_l_Graph,"traditional WPs","fl")
leg_l.Draw("same")
...
ItertativeFit_graph_b_TightWP = ROOT.TGraphAsymmErrors(1,np.asarray([80.]),np.asarray([hist_DeepCSVcTag_SFb.GetBinContent(2,2)]),np.asarray([50.]),np.asarray([120.]),np.asarray([hist_DeepCSVcTag_SFb.GetBinContent(2,2)-hist_DeepCSVcTag_SFb_Down.GetBinContent(2,2)]),np.asarray([hist_DeepCSVcTag_SFb_Up.GetBinContent(2,2)-hist_DeepCSVcTag_SFb.GetBinContent(2,2)]) )
...
leg_b.AddEntry(ItertativeFit_graph_b_TightWP,"c-tag shape reweighting","pe")
leg_b.AddEntry(TightWP_b_Graph,"traditional WPs","fl")
leg_b.Draw("same")
...
ItertativeFit_graph_c_TightWP = ROOT.TGraphAsymmErrors(1,np.asarray([80.]),np.asarray([hist_DeepCSVcTag_SFc.GetBinContent(2,2)]),np.asarray([50.]),np.asarray([120.]),np.asarray([hist_DeepCSVcTag_SFc.GetBinContent(2,2)-hist_DeepCSVcTag_SFc_Down.GetBinContent(2,2)]),np.asarray([hist_DeepCSVcTag_SFc_Up.GetBinContent(2,2)-hist_DeepCSVcTag_SFc.GetBinContent(2,2)]) )
...
leg_c.AddEntry(ItertativeFit_graph_c_TightWP,"c-tag shape reweighting","pe")
leg_c.AddEntry(TightWP_c_Graph,"traditional WPs","fl")
leg_c.Draw("same")

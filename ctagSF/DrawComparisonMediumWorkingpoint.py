...
leg_l.AddEntry(ItertativeFit_graph_l_MediumWP,"c-tag shape reweighting","pe")
leg_l.AddEntry(MediumWP_l_Graph,"traditional WPs","fl")
leg_l.Draw("same")
...
leg_b.AddEntry(ItertativeFit_graph_b_MediumWP,"c-tag shape reweighting","pe")
leg_b.AddEntry(MediumWP_b_Graph,"traditional WPs","fl")
leg_b.Draw("same")
...
leg_c.AddEntry(ItertativeFit_graph_c_MediumWP,"c-tag shape reweighting","pe")
leg_c.AddEntry(MediumWP_c_Graph,"traditional WPs","fl")
leg_c.Draw("same")
